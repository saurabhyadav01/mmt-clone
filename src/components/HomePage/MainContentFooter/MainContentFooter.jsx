export const MainContentFooter = ()=>{
    return <div className="homepage-main-content-footer">
        <div>
        ...
        <div>
            <h5>MAKEMYTRIP</h5>
            <p>
            About Us, Investor Relations, Careers, Corporate Travel, MMT Foundation, CSR Policy, myPartner - Travel Agent Portal, Foreign Exchange, List your hotel, Partners- Redbus, Partners- Goibibo, Advertise with Us
            </p>
        </div>
        <div>
